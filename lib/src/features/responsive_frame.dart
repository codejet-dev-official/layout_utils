...
import 'package:layout_utils/src/widgets/responsive_navigation_bar.dart';
...
class ResponsiveFrame extends StatelessWidget {
  const ResponsiveFrame({
    ...
    this.appBar,
    this.enableDefaultNavigationBar = false,
    this.defaultNavigationBarDecoration,
    ...
    this.restorationId,
    this.defaultNavigationBarTitle,
    this.defaultNavigationBarMenus,
    this.defaultNavigationBarLeading,
    this.defaultNavigationBarTrailing, required this.constraints,
  });
  ...
  final bool enableDefaultNavigationBar;
  final BoxDecoration? defaultNavigationBarDecoration;
  final BoxConstraints constraints;
  final Widget? defaultNavigationBarTitle;
  final List<Widget>? defaultNavigationBarMenus;
  final Widget? defaultNavigationBarLeading;
  final Widget? defaultNavigationBarTrailing;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: constraints.maxWidth <= Constants.mMaxWidth
          ? drawer
          : constraints.maxWidth <= Constants.tMaxWidth &&
          constraints.maxWidth > Constants.mMaxWidth
          ? null
          : null,
      onDrawerChanged: onDrawerChanged,
      endDrawer: endDrawer,
      onEndDrawerChanged: onEndDrawerChanged,
      bottomNavigationBar: constraints.maxWidth <= Constants.mMaxWidth
          ? bottomNavigationBar
          : constraints.maxWidth <= Constants.tMaxWidth &&
          constraints.maxWidth > Constants.mMaxWidth
          ? null
      ...
      appBar: enableDefaultNavigationBar
          ? ResponsiveNavigationBar(
              navigationBarSize: Size(constraints.maxWidth, 100),
              screenSize: Size(constraints.maxWidth, constraints.maxHeight),
              decoration: defaultNavigationBarDecoration,
              leading: defaultNavigationBarLeading,
              title: defaultNavigationBarTitle,
              trailing: defaultNavigationBarTrailing,
              menus: defaultNavigationBarMenus,
            )
          : appBar,
      body: constraints.maxWidth <= Constants.mMaxWidth
          ? mobileLayout
          : constraints.maxWidth <= Constants.tMaxWidth &&
          constraints.maxWidth > Constants.mMaxWidth
              ? tabletLayout
